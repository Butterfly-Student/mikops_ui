...
type KasMultiDeleteDialogProps<TData> = {
  open: boolean
...
export function KasMultiDeleteDialog<TData>({ open, onOpenChange, table }: KasMultiDeleteDialogProps<TData>) {
  ...
  const handleDelete = () => {
    ...
    toast.promise(sleep(2000), {
      ...
      success: () => {
        ...
        return `Terhapus ${selectedRows.length} transaksi`
      },
      error: "Error",
    })
  }
    ...
    <ConfirmDialog
      ...
      desc={
        <div className="space-y-4">
          <p className="mb-2">
            Apakah Anda yakin ingin menghapus transaksi terpilih? <br />
